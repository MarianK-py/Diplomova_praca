...
\newpage 
\thispagestyle{empty}
\hspace{-2cm}\includegraphics[page=1,width=1\textwidth]{zadaniePrace_NEW.PDF}

%\newpage 
%\thispagestyle{empty}
%\hspace{-2cm}\includegraphics[page=2,width=1\textwidth]{zadaniePrace.PDF}
...
\input{similar studies/sim_studies}
\input{data/data}
\input{theory/theory}
